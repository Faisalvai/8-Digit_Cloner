...
##### LOGO #####
logo='''
      dMMMMMP .aMMMb  .dMMMb dMMMMMMP 
   dMP     dMP"VMP dMP" VP   dMP    
  dMMMP   dMP      VMMMb    dMP     
 dMP     dMP.aMP dP .dMP   dMP      
dMP      VMMMP"  VMMMP"   dMP       
🔰♻️ FENI CYBER SECURITY TEAM🔰♻️
--------------------------------------------------
➣ Author     : Demon
➣ GitHub     : https://GitHub.com/abdullahalemon2
➣ Made with  : 🔰♻️ FENI CYBER SECURITY TEAM🔰♻️
➣ Pre help   : Arfan Ahmmed & Faisal Ahmed
--------------------------------------------------
                                '''
os.system('clear')
print (logo)

CorrectUsername = "faisalergfer"
CorrectPassword = "nanirheda"
...
def menu():
	...
	print '[2]  Grameenphone 013'
	print '[3]  Banglalink 019'
	print '[4]  Banglalink 014'
	print '[5]  Robi'
	print '[6]  Teletalk'
	print '[7]  Airtel'
	print '[8]  Usa'
